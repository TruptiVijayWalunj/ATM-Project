...
public class balance extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection( "jdbc:mysql://localhost:3306/bank", "root", "trupti08"
            );

            // Insert query
            String query = "INSERT INTO  mini_statement (id, deposite,withdraw,balance) VALUES (1,200,300,500)";
